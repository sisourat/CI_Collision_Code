...
!$OMP PARALLEL PRIVATE(alpi,alpj,alpk,alpl,Gamik,Gamjl,kfactorik,kfactorjl,xpik,xpjl,ypik,ypjl,zpik,zpjl,cx2c,cy2c,cz2c) 
...
!         write(*,*) igto,jgto,kgto,lgto 
      ...
      !   write(*,*) "Cgto"
                    ...
                    !      write(*,*) icgto,jcgto,kcgto,lcgto
!write(*,*) 'num'
                       !    write(*,*)  itrans,jtrans,ktrans,ltrans
...
!  write(*,*)  kicgto,kjcgto,kkcgto,klcgto

!  write(*,*)  kirep,kjrep,kkrep,klrep
!write(*,*)Centers(i)%block(iy)%cgto(itrans,igto),Centers(j)%block(jy)%cgto(jtrans,jgto),Centers(k)%block(ky)%cgto(ktrans,kgto),Centers(l)%block(ly)%cgto(ltrans,lgto)
