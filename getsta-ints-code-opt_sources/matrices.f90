...
use omp_lib
  ...
  double complex, dimension(:,:,:,:), allocatable :: SrepCGto, repCGto , t2eCGTO, Ov2eCGTO, pot2eCGTO, kin2eCGTO, Coup2eCGTO, MOint   !, tptpvec
...
!  double complex, dimension(:,:,:), save, allocatable :: ttcgtocoup, ttcgtoovl, tpcgtocoup, tpcgtoovl
!  double complex, dimension(:,:,:), save,  allocatable :: ppcgtocoup, ppcgtoovl, ptcgtocoup, ptcgtoovl
